...
public class RegisterApi {
    ...
    public ResponseEntity registerByPhone(@Valid @RequestBody PhoneRegisterParam param) {
    ...
    public ResponseEntity registerByWeChat(@Valid @RequestBody WeChatRegisterParam param) {
