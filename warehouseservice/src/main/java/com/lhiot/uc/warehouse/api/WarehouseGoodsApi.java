...
public class WarehouseGoodsApi {
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(paramType = "body", name = "warehouseGoods", value = "要存入的仓库商品", required = true, dataType ="WarehouseGoods",
                    dataTypeClass =com.lhiot.uc.warehouse.domain.entity.WarehouseGoods[].class, allowMultiple=true ),
    ...
    @ApiImplicitParams({
            ...
            @ApiImplicitParam(paramType="query",name="remark", value="备注",dataType="String"),
            @ApiImplicitParam(paramType = "body", name ="WarehouseGoodsParamList", value="转出申请商品列表",required=true)
    })
